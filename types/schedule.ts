...
export interface Schedule {
  ...
  /**
   * Actual staff assigned to this specific schedule.
   *
   * trainerId:
   * The trainer who will deliver this scheduled course.
   *
   * coordinatorId:
   * The coordinator responsible for following up on this schedule.
   */
  trainerId?: string;
