...
function ServiceDetailsContent() {
     const params = useSearchParams(); const [id] = useState(params.get('id') || ''); const [s, setS] = useState<Service | null>(null); useEffect(() => { serviceRepository.findById(id).then(setS); }, [id]); if (!s)
